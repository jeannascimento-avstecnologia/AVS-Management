...
| [SPEC_MENSALIDADES_VERSOES_PDF.md](./SPEC_MENSALIDADES_VERSOES_PDF.md) | Versões, mensalidades no passo Revisão, PDF vX |
| [SPEC_QUOTE_MARGEM.md](./SPEC_QUOTE_MARGEM.md) | Passo 3 interno: custo vs lucro (VHSYS + horas analista) |
